                                ...
                                <tbody>
                                    @foreach(user_atas_get() as $no=>$o)
                                        <tr class="odd gradeX">
                                            ...
                                            <td>Monitoring Laporan Semua OPD</td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
                                        ...
                                        <form id="tambah-data" onkeypress="return event.keyCode != 13"  action="{{url('/Pengguna')}}" method="post" enctype="multipart/form-data">
                                            ...
                                            @if($role==2)
                                                <div class="form-group row m-b-10">
                                                    ...
                                                    <div class="col-lg-5">
                                                        <select class="select2 form-control" name="akses">
