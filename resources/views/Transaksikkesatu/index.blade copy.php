                ...
                <div class="panel panel-inverse" data-sortable-id="ui-general-1">
					...
					<div class="panel-body">
                        ...
                        <h1 class="page-header">
                            <span class="btn btn-sm btn-blue" onclick="tambah()"><i class="fas fa-edit"></i> Buat LKE</span>
                        ...
                        <table id="data-table-responsive" class="table table-striped table-bordered table-td-valign-middle">
                            <thead>
                                <tr>
                                    <th width="4%">No</th>
                                    <th width="2%"></th>
                                    <th class="text-nowrap">Nomor LKE</th>
                            ...
                            <tbody>
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td width="1%"><span class="btn btn-green btn-xs" onclick="penilaian(`{{base64_encode($o->id)}}`)">penilaian</span></td>
                                    <td>{{$o->nomor}}</td>
                                    <td>{{$o->name}}</td>
