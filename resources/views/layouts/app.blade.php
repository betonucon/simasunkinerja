	...
	<div id="page-container" class="fade">
		...
		<div class="register register-with-news-feed">
			...
			<div class="news-feed" id="news-feed">
				<div class="news-image" style="background-image: url({{url('img/bglogin33.jpg')}})"></div>
				<div class="news-caption">
					<h4 class="caption-title"><b></b> INSPEKTORAT KOTA CILEGON</h4>
					<p>
						Sistem Informasi Manajemen evaluASi akUNtabilitas (SIMASUN) kinerja
					</p>
				</div>
			</div>
			<!-- end news-feed -->
