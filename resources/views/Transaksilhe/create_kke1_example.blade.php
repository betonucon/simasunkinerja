                        ...
                        <table class="table table-bordered">
                            ...
                            @foreach(parameter_kkesatu_get() as $no=>$param)
                                ...
                                @foreach(detail_parameter_kkesatu_get($param->id) as $no=>$detailparam)
                                    ...
                                    <tr>
                                        ...
                                        <td style="background:#ecefef;text-align:center">
                                            22{{$detailparam->id}}-{{$detailparam->id}}
                                        ...
                                        <td style="background:#ecefef;text-align:center">
                                            32{{$detailparam->id}}-{{$detailparam->id}}
                                        ...
                                        <td style="background:#ecefef;text-align:center">
                                            42{{$detailparam->id}}-{{$detailparam->id}}
                                        ...
                                        <td style="background: #50505257;text-align:center" >{{value_kkesatu_id($data->id,'42'.$detailparam->id)}}</td>
                                            ...
                                            @endif
                                        <td style="background:#ecefef;text-align:center">
                                            52{{$detailparam->id}}-{{$detailparam->id}}
                                ...
                                <tr>
                                    ...
                                    <td style="background:#fff"></td>
                                    <td style="background:#fff"></td>
                                    <td style="background:yellow;text-align:center">{{($nilai311/2)*100}}</td>
                                    <td style="background:#fff"></td>
                                    <td style="background:#fff"></td>
                                    <td style="background:#fff"></td>
                                    <td style="background:yellow;text-align:center">{{($nilai411/2)*100}}</td>
                                    <td style="background:#fff"></td>
                                    <td style="background:#fff"></td>
                                    <td style="background:#fff"></td>
                                    <td style="background:yellow;text-align:center">{{($nilai511/2)*100}}</td>
                                </tr>  
                            @endforeach
                                <tr>
                                    <td style="background:#fff" ><b></b></td>
