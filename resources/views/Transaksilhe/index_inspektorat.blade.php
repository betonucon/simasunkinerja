                            ...
                            <thead>
                                <tr>
                                    ...
                                    @foreach(parameter_get() as $par)
                                        <th width="8%" class="text-wrap" style="text-align:center;font-size:10px">{{$par->name}}</th>
                                    @endforeach
                                    <th width="4%" class="text-wrap" style="text-align:center;font-size:10px">LKE</th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    @foreach(parameter_get() as $par)
                                        <!-- <td>{{uang((nilai_parameter(lhe_id($o->id,$tahun),$par->id)/$par->nilai)*100)}}%</td> -->
                                        <td class="text-center">{{kalkulasi((nilai_parameter(lhe_id($o->id,$tahun),$par->id)/$par->nilai)*100)}}</td>
                                    @endforeach
                                    <!-- <td class="text-center">{{(total_nilai_parameter(lhe_id($o->id,$tahun))/100)*100}}%</td> -->
                                    <td class="text-center">{{kalkulasi((total_nilai_parameter(lhe_id($o->id,$tahun))/100)*100)}}</td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
