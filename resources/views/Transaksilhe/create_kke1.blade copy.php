					...
					<div class="panel-body">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <th width="10%" colspan="2">TARGET TERCAPAI</th>
                                <th width="10%" colspan="2">KINERJA LEBIH BAIK</th>
                                <th width="10%" colspan="2">DATA ANDAL</th>
                            </tr>
                            <tr>
                                <th>1</th>
                                <th>2</th>
                            ...
                            @foreach(parameter_kkesatu_get() as $no=>$param)
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:center;font-weight:bold;background:#e3e3b8" >{{rekapan_detail_kkesatu_id($data->id,$param->id,'11')}}%</td>
                                    <td style="text-align:center" ></td>
                                    <td style="text-align:center;font-weight:bold;background:#e3e3b8" >{{rekapan_detail_kkesatu_id($data->id,$param->id,'21')}}%</td>
                                    <td style="text-align:center" ></td>
                                    <td style="text-align:center;font-weight:bold;background:#e3e3b8" >{{rekapan_detail_kkesatu_id($data->id,$param->id,'31')}}%</td>
                                    <td style="text-align:center" ></td>
                                    <td style="text-align:center;font-weight:bold;background:#e3e3b8" >{{rekapan_detail_kkesatu_id($data->id,$param->id,'41')}}%</td>
                                    <td style="text-align:center" ></td>
                                    <td style="text-align:center;font-weight:bold;background:#e3e3b8" >{{rekapan_detail_kkesatu_id($data->id,$param->id,'51')}}%</td>
                                </tr>  
                            @endforeach
                                <tr>
                                    <td style="background:aqua" ><b></b></td>
