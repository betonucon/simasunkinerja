					...
					<div class="panel-body">
                        ...
                        <table class="table table-bordered">
                            <tr>
                                ...
                                <th rowspan="2" width="17%">INDIKATOR KINERJA</th>
                            ...
                            @foreach(kkesatu_get(akses_opd(),$tahun) as $no=>$o)
                                <tr>
                                    <td style="background:aqua" class="td-center" rowspan="{{kkesatu_rowspan($o->id)}}"><b>{{$no+1}}.</b></td>
                                    <td style="background:aqua" class="td-center"  rowspan="{{kkesatu_rowspan($o->id)}}">
                                    ...
                                    <td style="background:#ffff90"  class="td-left" rowspan="{{kkesatu_rowspan($o->id)}}">{{$o->name}}</td>
                                    <td style="background:#ffff90"  class="td-left">
                                        <span class="btn btn-green btn-xs" onclick="ubah({{kkesatu_utama_id($o->id)}},`{{kkesatu_utama_name($o->id)}}`,`Indikator`)"><i class="fa fa-pencil-alt"></i></span>
                                        <span class="btn btn-red btn-xs" onclick="hapus({{kkesatu_utama_id($o->id)}},`detail`)"><i class="fa fa-times-circle"></i></span>
                                        <br>{{kkesatu_utama_name($o->id)}}
                                    </td>
                                    <td  rowspan="{{kkesatu_rowspan($o->id)}}"></td>
                                    <td  rowspan="{{kkesatu_rowspan($o->id)}}"></td>
                                    <td> </td>
                                    <td></td>
                                    <td></td>
    ...
    <script>
        ...
        function update_data_sasaran(){
            var form=document.getElementById('ubah-data-sasaran');
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{url('/Lhe/save_kke1_sasaran')}}?act=ubah",
                    data: new FormData(form),
                    contentType: false,
                    cache: false,
                    processData:false,
